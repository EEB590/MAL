...
taxa <- c("Fruit fly", "Hawkmoth", "Butterfly", "Short-tongue bee", "Stingless bee", "Bumblebee", "Honeybee", "Hummingbird", "Sunbird", "Honeyeater", "Bat")
...
ggplot(conc, aes(x = taxa, y = max)) +
  ...
  labs(x = "Taxon", y = "Concentration (BRIX)", title = "Nectar Concentrations, Optimal vs. Observed") +
